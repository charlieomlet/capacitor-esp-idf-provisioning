...
export declare enum ESPTransport {
    ble = "ble",
    softap = "softap"
}
export declare enum ESPSecurity {
    unsecure = "unsecure",
    secure = "secure",
    secure2 = "secure2"
}
export declare type ESPDeviceAdvertisingData = {
    localName?: string;
    isConnectable?: number;
    manufacturerData?: any;
    serviceUUIDs?: string[];
};
export declare type ESPDevice = {
    name: string;
    advertisementData?: ESPDeviceAdvertisingData;
};
export declare type ESPNetwork = {
    ssid: string;
    rssi: number;
